...
% Note. For the workshop paper template, both \title{} and \workshoptitle{} are required, with the former indicating the paper title shown in the title and the latter indicating the workshop title displayed in the footnote. 
\title{Group 13 Project Proposal for SYS5185/IAI5101}
...
\author{%
  Önder Emre Arıkan\\
  Microprogram in Interdisciplinary AI\\
  300515038\\
  \texttt{oarik043@uottawa.ca} \\
  \And
  René Duplain\\
  Microprogram in Interdisciplinary AI\\
  3053046\\
  \texttt{Rene.Duplain@uottawa.ca} \\
  \And
  Jad Mghabghab\\
  Computer Engineering\\
  300220683\\
  \texttt{jmgha088@uottawa.ca} \\
...
\begin{abstract}
  Here is where our abstract will go!!\newline
